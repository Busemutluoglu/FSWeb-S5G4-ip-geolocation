...
function BenimIP(f) {
  ...
  ulke.textContent = "".concat(f.ülke, " (").concat(f.ülkeKodu, ")");
  var enBoy = document.createElement("p");
  mySecDiv.appendChild(enBoy);
  enBoy.textContent = "Enlem: ".concat(f.enlem, " Boylam: ").concat(f.boylam);
  var city = document.createElement("p");
  mySecDiv.appendChild(city);
  city.textContent = "\u015Eehir:  ".concat(f.şehir);
  var time = document.createElement("p");
  mySecDiv.appendChild(time);
  time.textContent = "Saat dilimi:  ".concat(f.saatdilimi);
  var money = document.createElement("p");
  mySecDiv.appendChild(money);
  money.textContent = "Para birimi:  ".concat(f.parabirimi);
  var isp = document.createElement("p");
  mySecDiv.appendChild(isp);
  isp.textContent = "ISP:  ".concat(f.isp);
  return myDiv;
}
